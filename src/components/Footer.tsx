          ...
          <div className="col-span-12 md:col-span-4">
            <div>
              ...
              <div className="flex items-center space-x-6">
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@mojli.ai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:scale-110 gentle-animation cursor-pointer"
                >
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/mojli.ai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:scale-110 gentle-animation cursor-pointer"
                >
                ...
                {/* LinkedIn */}
                <a
                  href="https://linkedin.com/company/mojli"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:scale-110 gentle-animation cursor-pointer"
                >
        ...
        <div className="border-t border-background/20 pt-8 mt-16">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-background/70 mb-4 md:mb-0">
              © 2025 MOJLI. All rights reserved.
            </div>

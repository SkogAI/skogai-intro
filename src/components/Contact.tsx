...
export function Contact() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal("init", "mojli-discovery-call", {origin:"https://app.cal.com"});
      
      Cal.ns["mojli-discovery-call"]("inline", {
        elementOrSelector:"#my-cal-inline-mojli-discovery-call",
        config: {"layout":"month_view"},
        calLink: "molku/mojli-discovery-call",
      });
      
      Cal.ns["mojli-discovery-call"]("ui", {"hideEventTypeDetails":false,"layout":"month_view"});
    `
          ...
          <div className="bg-background clean-border rounded-3xl overflow-hidden elevated-shadow">
            ...
            <div className="p-0 bg-white">
              <div 
                ...
                id="my-cal-inline-mojli-discovery-call"
              />
            </div>
          </div>
        </div>
